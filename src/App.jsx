              ...
              <div className="card" style={{ borderRadius: "15px" }}>
                <div className="card-body text-center">
                  ...
                  <p className="text-muted mt-3 shado">
                    Soy tranquila y amigable, tengo {age} años y algunas
                        ...
                        <div className="accordion-body">
                          <div className="row pt-1">
                            <div className="col-md-12 d-flex">
                              <div className="w-50">
                                <h6>Fecha</h6>
                                <p className="text-muted">27-01-2023</p>
                                <p className="text-muted">27-01-2023</p>
                                <p className="text-muted">05-01-2022</p>
                              </div>
                              <div className="w-50">
                                <h6>Vacuna</h6>
                                ...
                                <p className="text-muted word-wrap">Prantel Plus</p>
                              </div>
                            </div>
                          </div>
                        </div>
